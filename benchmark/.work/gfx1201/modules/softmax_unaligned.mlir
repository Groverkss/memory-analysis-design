module {
  func.func @softmax_unaligned(%arg0: tensor<1024x511xf16>) -> (tensor<1024x511xf16>) {
    ...
    %max = linalg.generic {
      ...
      ins(%arg0 : tensor<1024x511xf16>) outs(%fill_max : tensor<1024xf16>) {
    ^bb0(%in: f16, %out: f16):
    ...
    %exp = linalg.generic {
      ...
      ins(%arg0, %max : tensor<1024x511xf16>, tensor<1024xf16>) outs(%empty_exp : tensor<1024x511xf16>) {
    ...
    return %result : tensor<1024x511xf16>
  }
}
