module {
  func.func @softmax_medium(%arg0: tensor<2048x4096xf16>) -> (tensor<2048x4096xf16>) {
    ...
    %max = linalg.generic {
      ...
      ins(%arg0 : tensor<2048x4096xf16>) outs(%fill_max : tensor<2048xf16>) {
    ^bb0(%in: f16, %out: f16):
    ...
    %exp = linalg.generic {
      ...
      ins(%arg0, %max : tensor<2048x4096xf16>, tensor<2048xf16>) outs(%empty_exp : tensor<2048x4096xf16>) {
