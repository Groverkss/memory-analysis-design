module {
  func.func @rms_norm_unaligned(%arg0: tensor<4096x768xf16>, %arg1: tensor<768xf16>) -> (tensor<4096x768xf16>) {
    ...
    %squared = linalg.generic {
      ...
      ins(%arg0 : tensor<4096x768xf16>) outs(%empty_2d : tensor<4096x768xf32>) {
    ^bb0(%in: f16, %out: f32):
    ...
    %result = linalg.generic {
      indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>,
                       ...
                       affine_map<(d0, d1) -> (d0, d1)>],
      iterator_types = ["parallel", "parallel"]}
      ins(%arg0, %rrms, %arg1 : tensor<4096x768xf16>, tensor<4096xf32>, tensor<768xf16>) outs(%empty_out : tensor<4096x768xf16>) {
    ...
    return %result : tensor<4096x768xf16>
  }
}
