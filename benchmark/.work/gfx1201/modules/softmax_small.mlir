module {
  func.func @softmax_small(%arg0: tensor<512x128xf32>) -> (tensor<512x128xf32>) {
    ...
    %max = linalg.generic {
      ...
      ins(%arg0 : tensor<512x128xf32>) outs(%fill_max : tensor<512xf32>) {
    ^bb0(%in: f32, %out: f32):
    ...
    %exp = linalg.generic {
      ...
      ins(%arg0, %max : tensor<512x128xf32>, tensor<512xf32>) outs(%empty_exp : tensor<512x128xf32>) {
