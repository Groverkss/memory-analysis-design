module {
  func.func @layernorm_3d(%arg0: tensor<8x512x10x128xf16>, %arg1: tensor<10x128xf16>, %arg2: tensor<10x128xf16>) -> (tensor<8x512x10x128xf16>) {
    ...
    %extended = linalg.generic {
      ...
      ins(%arg0 : tensor<8x512x10x128xf16>) outs(%empty_4d : tensor<8x512x10x128xf32>) {
    ^bb0(%in: f16, %out: f32):
    ...
    %result = linalg.generic {
      indexing_maps = [affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>,
                       ...
                       affine_map<(d0, d1, d2, d3) -> (d0, d1, d2, d3)>],
      iterator_types = ["parallel", "parallel", "parallel", "parallel"]}
      ins(%arg0, %mean, %rstd, %arg1, %arg2 : tensor<8x512x10x128xf16>, tensor<8x512xf32>, tensor<8x512xf32>, tensor<10x128xf16>, tensor<10x128xf16>) outs(%empty_out : tensor<8x512x10x128xf16>) {
    ...
    return %result : tensor<8x512x10x128xf16>
  }
}
