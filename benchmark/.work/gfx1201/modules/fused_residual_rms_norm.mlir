module {
  func.func @fused_residual_rms_norm(%arg0: tensor<2048x4096xf16>, %arg1: tensor<2048x4096xf16>, %arg2: tensor<4096xf16>) -> (tensor<2048x4096xf16>, tensor<2048x4096xf16>) {
    ...
    %added = linalg.generic {
      ...
      ins(%arg0, %arg1 : tensor<2048x4096xf16>, tensor<2048x4096xf16>) outs(%empty_2d_f16 : tensor<2048x4096xf16>) {
    ...
    %result = linalg.generic {
      indexing_maps = [affine_map<(d0, d1) -> (d0, d1)>,
                       ...
                       affine_map<(d0, d1) -> (d0, d1)>],
      iterator_types = ["parallel", "parallel"]}
      ins(%added, %rrms, %arg2 : tensor<2048x4096xf16>, tensor<2048xf32>, tensor<4096xf16>) outs(%empty_out : tensor<2048x4096xf16>) {
    ...
    return %result, %added : tensor<2048x4096xf16>, tensor<2048x4096xf16>
  }
}
